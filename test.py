...
from pattern_stats import extract_type_patterns, compute_confidences, compute_confidences_cosine, compute_confidences_combined
...
def main(config):
    ...
    with open(config['anomalies_output'],'r') as f:
